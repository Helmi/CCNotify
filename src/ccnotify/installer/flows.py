...
from .welcome import (
    display_welcome_screen, display_success_message, display_error_message,
    display_warning_message, display_progress_header, animate_thinking
)
...
class FirstTimeFlow(BaseFlow):
    ...
    def _handle_migration(self) -> bool:
        ...
        console.print(f"[yellow]Found legacy installation in {migration_info['legacy_dir']}[/yellow]")
    ...
    def _display_installation_success(self) -> None:
        ...
        success_text.append("🔊 Voice notifications are now active for Claude Code\n", style="green")
        success_text.append("🎯 Try running commands in Claude Code to test notifications\n", style="green")
...
class UpdateFlow(BaseFlow):
    ...
    def _display_installation_status(self, status: InstallationStatus, update_info: UpdateInfo) -> None:
    ...
    def _has_updates(self, update_info: UpdateInfo) -> bool:
        ...
        return (update_info.script_update_available or 
