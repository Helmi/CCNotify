...
class InstallationDetector:
    ...
    def check_existing_installation(self) -> InstallationStatus:
        ...
        if self.ccnotify_dir.exists():
            ...
            status.models_downloaded = model_status.kokoro_downloaded or model_status.elevenlabs_configured
        ...
        if self.legacy_hooks_dir.exists():
            ...
            if not status.exists:
                status.issues.append("Found legacy installation in ~/.claude/hooks/ - needs migration")
