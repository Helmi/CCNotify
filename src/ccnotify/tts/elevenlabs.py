...
class ElevenLabsProvider(TTSProvider):
    ...
    def generate(self, text: str, output_path: Path, **kwargs) -> bool:
        ...
        try:
            ...
            self.logger.debug(f"Generating TTS: '{text[:50]}...' with voice={voice_id}, model={model_id}")
    ...
    def test_voice(self, voice_id: str, test_text: str = "Hello, this is a test of ElevenLabs TTS") -> bool:
        """
