...
def _build_provider_config(provider_name: str, base_config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if provider_name == "kokoro":
        ...
        config.update({
            ...
            "voice_id": os.getenv("ELEVENLABS_VOICE_ID", base_config.get("voice_id", "21m00Tcm4TlvDq8ikWAM")),
            "model_id": os.getenv("ELEVENLABS_MODEL_ID", base_config.get("model_id", "eleven_flash_v2_5")),
    ...
    for provider_name in TTS_PROVIDERS.keys():
        try:
            ...
            if provider:
                ...
                with NamedTemporaryFile(suffix=provider.get_file_extension(), delete=False) as tmp_file:
